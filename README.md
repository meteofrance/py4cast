...
runai gpu_play 4
runai build
runai exec_gpu python bin/py4cast_main.py fit --config config/CLI/trainer.yaml --config config/CLI/poesy.yaml --config config/CLI/halfunet.yaml
```
...
runai sbatch python bin/py4cast_main.py fit --config config/CLI/trainer.yaml --config config/CLI/poesy.yaml --config config/CLI/halfunet.yaml
```
...
export RUNAI_GRES="gpu:v100:4"
runai sbatch_multi_node python bin/py4cast_main.py fit --config config/CLI/trainer.yaml --config config/CLI/poesy.yaml --config config/CLI/halfunet.yaml
```
...
```sh
python bin/py4cast_main.py fit --config config/CLI/trainer.yaml --config config/CLI/dummy.yaml --config config/CLI/halfunet.yaml
```
...
srun python bin/py4cast_main.py fit --config config/CLI/trainer.yaml --config config/CLI/poesy.yaml --config config/CLI/halfunet.yaml
```
...
#### Dataset config 
```bash
python bin/py4cast_main.py fit --config config/CLI/trainer.yaml --config config/CLI/poesy.yaml --config config/CLI/halfunet.yaml
```
